...
(cl:in-package learing_service-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <person-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learing_service-srv:<person-request> is deprecated: use learing_service-srv:person-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learing_service-srv:name-val is deprecated.  Use learing_service-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learing_service-srv:age-val is deprecated.  Use learing_service-srv:age instead.")
  (age m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <person-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learing_service-srv:sex-val is deprecated.  Use learing_service-srv:sex instead.")
  (sex m))
...
(cl:defmethod cl:initialize-instance :after ((m <person-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name learing_service-srv:<person-response> is deprecated: use learing_service-srv:person-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <person-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learing_service-srv:result-val is deprecated.  Use learing_service-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<person-response>)))
  ...
  "learing_service/personResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'person-response)))
  "Returns string type for a service object of type 'person-response"
  "learing_service/personResponse")
